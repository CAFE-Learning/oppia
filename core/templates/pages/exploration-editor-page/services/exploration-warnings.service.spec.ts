...
describe('Exploration Warnings Service', () => {
  ...
  it('should update warnings with TextInput as interaction id', () => {
    ...
    expect(explorationWarningsService.getWarnings()).toEqual([
      ...
      },
      {
        type: 'critical',
        message:
          'Please ensure the value of parameter "HtmlValue" is set' +
      ...
      },
      {
        type: 'error',
        message:
          "In 'Hola', the following answer group has a classifier" +
  ...
  it('should update warnings with Continue as interaction id', () => {
    ...
    expect(explorationWarningsService.getWarnings()).toEqual([
      ...
      },
      {
        type: 'error',
        message:
          "In 'Hola', the following answer groups have classifiers" +
  ...
  it('should update warnings when there is a solution in the interaction', fakeAsync(() => {
    explorationStatesService.init(
      {
        Hola: {
          classifier_model_id: null,
  ...
  it('should update warnings when state top answers stats is initiated', fakeAsync(async () => {
    explorationStatesService.init(
      {
        Hola: {
          classifier_model_id: null,
  ...
  it(
    'should update warnings when state name is not equal to the default' +
      ' outcome destination',
    () => {
      explorationStatesService.init(
        {
  ...
  it(
    'should update warnings when there are two states but only one saved' +
      ' memento value',
    () => {
      explorationStatesService.init(
        {
      ...
      expect(explorationWarningsService.getWarnings()).toEqual([
        ...
        },
        {
          type: 'error',
          message:
            "In 'State', the following answer group has a classifier" +
            ' with no training data: 0',
        },
      ]);
  ...
  it(
    'should show warnings if checkpoint count is more than 8 and' +
  ...
  it(
    'should show warnings if learner is directed more than 3 cards' +
